...
const AboutPage = () => {
  return (
    <div className="w-full bg-[#F9FAFB] min-h-screen py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Mission Statement */}
        <section className="mb-12 bg-white rounded-2xl shadow p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center">
          ...
          <img
            ...
            alt="Our Mission"
            className="w-32 h-32 object-contain rounded-xl shadow hidden md:block"
          />
        </section>
        ...
        {/* Values */}
        <section className="mb-12 bg-white rounded-2xl shadow p-8 md:p-12">
